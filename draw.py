...
async def draw_info(arcid: Union[int, str]) -> str:
    try:
        ...
        if isinstance(info, dict):
            ...
            font.draw_partial_opacity(900, 2990, 25, f'Draw Time {playtime(time() * 1000)}  |  Generated by {BotNickname}  |  Powered by project Arcaea', anchor='ms')
            # save
...
async def draw_score(project: str, arcid: int, mode: int = 0, name: str = None, diff: int = None) -> Union[MessageSegment, str]:
    try:
        ...
        if randint == 1:
            ...
            # info
            font.draw_partial_opacity(356, 1400, 20, f'Generated by {BotNickname} | Powered by project Arcaea', anchor='ms')
